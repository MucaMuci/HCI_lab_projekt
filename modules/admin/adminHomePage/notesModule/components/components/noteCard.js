...
const NoteRed = ({ text }) => {
  ...
  return (
    <div
      className={
        NoteRedChecked
          ? "flex flex-row items-center mx-5 border mt-5 line-through"
          : "flex flex-row items-center mx-5 border mt-5"
      }
    >
      ...
      <input
        className="flex justify-end self-start my-1.5 mx-1.5"
        type="checkbox"
        defaultChecked={NoteRedChecked}
        onChange={addRedNoteToCompleted}
