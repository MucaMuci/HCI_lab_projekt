  ...
  return (
    <div className={formStep === 0 ? "flex" : "hidden"}>
      <div className="flex flex-col px-5 sm:px-20 py-3 font-medium max-w-5xl border border-hci-siva rounded-xl">
        ...
        <div className="pt-2 text-sm font-medium">Number of people</div>
        ...
        <div className="flex">
          <div className="hover:cursor-pointer font-normal border px-1 text-lg text-hci-modra border-hci-siva rounded-md bg-hci-siva-2 w-fit">
            {" "}
            Yes
          </div>
        ...
        <div className="pt-6 text-sm font-medium">Check-out time</div>
        <div className="flex">
          <input
            className="border  border-hci-siva rounded-md bg-hci-siva-2 w-1/12 text-lg placeholder-hci-siva-slova text-center"
            placeholder="19"
        ...
        <div className="pt-6 font-medium">Comment</div>
        <textarea
          className="pl-1 border border-hci-siva rounded-md bg-hci-siva-2 text-lg placeholder-hci-siva-slova"
          rows="3"
