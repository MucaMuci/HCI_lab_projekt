  ...
  return (
    <div className={formStep === 2 ? "flex" : "hidden"}>
      <div className="flex flex-col px-5 sm:px-20 md:px-32 border border-hci-siva rounded-xl">
        <div className="text-sm pt-2 font-medium">Total price</div>
        <div className="flex flex-col">
          ...
          <div className="text-sm pt-6 font-medium">Payed</div>
          ...
          <div className="text-sm pt-2 font-medium">Still left to pay</div>
          <div className="flex items-center border border-hci-siva rounded-md bg-hci-siva-2">
            <input className="font-normal text-lg pl-2 text-hci-siva-slova border-hci-siva rounded-md bg-hci-siva-2  "></input>
            <div className="px-1 hover:cursor-pointer ">
              <Image src={DownArrow} width={20} height={12} alt="DownArrow" />
          ...
          <div className="text-sm pt-2 font-medium">Security deposit payed</div>
          <div className="flex items-center border border-hci-siva rounded-md bg-hci-siva-2">
            <input className="font-normal text-lg pl-2 text-hci-siva-slova border-hci-siva rounded-md bg-hci-siva-2  "></input>
            <div className="px-1 hover:cursor-pointer ">
              <Image src={DownArrow} width={20} height={12} alt="DownArrow" />
