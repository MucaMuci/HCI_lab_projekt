    ...
    return (
        <header className="bg-hci-header">
            <main className=" max-w-5xl mx-auto flex justify-between bg-hci-header ">
                ...
                <div className="md:flex md:self-center md:pr-3 rounded-full bg-gradient-to-r from-[#3531FF] to-[#5F0355] w-16 h-16 rotate-90 flex items-center justify-center ">
                    <Image className="-rotate-90 self-center"
                        src={UserManImg}
                        height={30}
                        width={30}
                    /> 
