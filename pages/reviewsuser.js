        ...
        <div className=" flex flex-col max-w-5xl mx-auto justify-center pt-5 pb-10 ">
          {user != undefined && (
            <div className="px-5 py-3 border shadow-btn-sjena w-full flex flex-col rounded-lg mb-10">
              <div className="flex justify-between pb-2">
                ...
                <div className="flex-1 hidden sm:block text-right">
                  <StarRatings
                    ...
                    numberOfStars={5}
                    starRatedColor="#ECCD2F"
                    starHoverColor="#ECCD2F"
                    starDimension="30px"
                  />
                </div>
                {user != undefined && (
              ...
              <div className="border-t border-t-black w-full pb-2"></div>
              <textarea
                value={text}
                onChange={handleText}
                className="bg-hci-svijetlo-siva py-1 rounded-lg px-1 text-black "
                placeholder="Write your experience"
              />

              <button
                onClick={shareReview}
                className="self-end text-hci-modra pt-1"
              >
                SHARE
              </button>
            </div>
