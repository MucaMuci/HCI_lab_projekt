  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="bg-hci-siva-2 flex justify-center py-2">
        <div className="text-4xl">BLOG LIST</div>
      </div>
      ...
      <div className="max-w-5xl mx-auto text-lg pb-32">
        ...
        <div className="flex font-medium text-lg pb-5 pt-5">
          <div className="flex w-2/6 pl-2">MADE BY</div>
          <div className="flex w-4/6 sm:w-3/6 ">POST NAME</div>
          <div className="hidden sm:flex w-1/6 ">DATE</div>
        </div>
