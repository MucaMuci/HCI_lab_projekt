                ...
                <div className='px-6 font-inter'>
                    <div className='bg-white flex flex-col border border-gray-300 px-5 pt-3 pb-8'>
                        ...
                        <div className='flex flex-col items-center'>
                            <input className='border border-gray-300 w-11/12 rounded py-2 px-1 bg-hci-bg ' value={email} onInput={e => setEmail(e.target.value)} placeholder='Email' required></input>
                            ...
                            <div className='pt-6 flex justify-center w-11/12'>
                                <button onClick={logIn} className='bg-hci-modra text-white text-medium text-lg rounded w-full py-1 shadow-btn-sjena'>
                                    Log In
                                </button>
                            </div>
