          ...
          <div className="flex justify-around flex-col sm:flex-row text-lg">
            <div className="flex flex-grow sm:flex-grow-0 flex-col items-start ">
              ...
              <div className="flex pt-2">
                ...
                <div className="flex text-hci-siva-slova">{maxpassengers}</div>
              </div>
              <div className="flex  pt-2">
                <div className="flex pr-2 font-medium">Length:</div>
                <div className="flex text-hci-siva-slova">{length}</div>
              </div>
              <div className="flex pt-2">
                <div className="flex pr-2 font-medium">Engine HP:</div>
                <div className="flex text-hci-siva-slova ">{engineHP}</div>
              </div>
...
const BoatUser = ({ name, price, maxpassengers, length, width, engineHP, fuel, additional }) => {
                    ...
                    {information == 0 &&
                        <div className="flex justify-around flex-col sm:flex-row text-lg">
                            ...
                            <div className="flex pt-10 sm:pt-2 flex-col">
                                ...
                                {/* <div className="text-hci-siva-slova flex sm:flex-col">
>>>>>>> 2a0ddb092ed0ce4361dfb2e56e97e27137a15e07
                    ...
                    {information == 1 &&
                        <div className="flex justify-around flex-col sm:flex-row text-lg">
                            <div className="flex flex-grow sm:flex-grow-0 flex-col items-start ">
                                ...
                                <div className="text-hci-siva-slova flex sm:flex-col">
                                    <div className="hidden">{additional.map((item, index) => {
